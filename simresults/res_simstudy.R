...
setwd("C:/Users/marta.bofill/Dropbox/C5/GitHub/PT_CovAdj/simresults")
# setwd("C:/Users/marta/Dropbox/C5/GitHub/PT_CovAdj/simresults")
...
scenarios <- list(
  ...
  list(name = "Equal alloc, no trend (h0)",
       mu0=0, mu1=0, mu2=0, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=100, N2=100, N3=100,
       alloc1=c(0.5,0.5), alloc2=c(1/3,1/3,1/3), alloc3=c(0.5,0.5),
       lambda=0, trendp="stepwise", sd=1),
  
  # 2. Unequal allocation - Condition B fails
  list(name = "Unequal alloc, no trend (h1)",
       mu0=0, mu1=1, mu2=2, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=100, N2=100, N3=100,
       alloc1=c(2,1)/3, alloc2=c(2,1,1)/4, alloc3=c(2,1)/3,
       lambda=0, trendp="stepwise", sd=1),
  
  # 3. Different period sizes - ECE vs ACA scenario
  list(name = "Equal alloc, trend, diff sizes N (h1)",
       mu0=0, mu1=1, mu2=2, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=50, N2=150, N3=100,
       alloc1=c(0.5,0.5), alloc2=c(1/3,1/3,1/3), alloc3=c(0.5,0.5),
       lambda=1, trendp="stepwise", sd=1),
  
  # 4. Covariate effect, null - adjustment benefit without inflation
  list(name = "Equal alloc, no trend, with cov effect (h0)",
       mu0=0, mu1=0, mu2=0, beta=2, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=100, N2=100, N3=100,
       alloc1=c(0.5,0.5), alloc2=c(1/3,1/3,1/3), alloc3=c(0.5,0.5),
       lambda=0, trendp="stepwise", sd=1),
  
  # 5. Covariate + diff sizes - adjusted estimators inherit ECE/ACA ranking
  list(name = "Equal alloc, trend, diff sizes N, with cov effect (h1)",
       mu0=0, mu1=1, mu2=2, beta=2, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=50, N2=150, N3=100,
       alloc1=c(0.5,0.5), alloc2=c(1/3,1/3,1/3), alloc3=c(0.5,0.5),
       lambda=1, trendp="stepwise", sd=1),
  
  # 6. Treatment-period interaction - estimands genuinely differ
  list(name = "Equal alloc, treat-period interaction (h1)",
       mu0=0, mu1=1, mu2=2, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=3, tau2=0,
       N1=100, N2=100, N3=100,
       alloc1=c(1,1)/2, alloc2=c(1,1,1)/3, alloc3=c(1,1)/2,
       lambda=1, trendp="stepwise", sd=1),
  
  # Extreme Scenario I: dominant competing arm
  list(name = "Dominant competing arm (extreme ECE vs ACA)",
       mu0=0, mu1=1, mu2=2, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=200, N2=1800, N3=200,
       alloc1=c(0.50, 0.50),
       alloc2=c(0.01, 0.01, 0.98),
       alloc3=c(0.50, 0.50),
       lambda=0, trendp="stepwise", sd=1),
  
  # Extreme Scenario II: highly variable allocation ratio
  list(name = "Variable allocation ratio (ACA suboptimal)",
       mu0=0, mu1=1, mu2=2, beta=0, gamma1=0, gamma2=0,
       delta=0, subgroup=F, tau1=0, tau2=0,
       N1=400, N2=200, N3=200,
       alloc1=c(0.95, 0.05),
       alloc2=c(1/3, 1/3, 1/3),
       alloc3=c(0.50, 0.50),
       lambda=0, trendp="stepwise", sd=1)
)
...
linesep_pattern[seq(22, n_rows, by = 22)] <- "\\addlinespace"

# Create the table
kable(summary_stats[,-c(6,9,11,12,14,15,16,17)], 
      format = "latex", 
      booktabs = TRUE, 
      digits = 3,
...
save(combined_results, summary_stats, scenarios, n_sims,
     file = "simulation_results_v2.RData") 
